...
Enablement guidance for **Billing, Invoicing & Payment Terms** at Northstar AI. This doc is intended to be used with related policies listed below; when policies conflict, follow the most recent **last_updated** date and escalate to the owner team.
...
- **seat_limits_and_billing.md** (KB-006)
...
- **Where do I record an exception?**  
  Record exceptions in CRM under the account and attach the approval. Include doc IDs (e.g., KB-004) and an expiry date.
...
- **Citation guidance:** Cite **doc_id** + section header (e.g., `KB-004 — Exceptions & edge cases`).
