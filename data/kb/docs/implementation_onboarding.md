---
  doc_id: KB-017
  title: Implementation & Onboarding Playbook (CS)
...
# Implementation & Onboarding Playbook (CS)
...
Enablement guidance for **Implementation & Onboarding Playbook (CS)** at Northstar AI. This doc is intended to be used with related policies listed below; when policies conflict, follow the most recent **last_updated** date and escalate to the owner team.
...
- **Where do I record an exception?**  
  Record exceptions in CRM under the account and attach the approval. Include doc IDs (e.g., KB-017) and an expiry date.
...
- **Escalation:** Customer Success → RevOps/Legal/Security as needed
- **Citation guidance:** Cite **doc_id** + section header (e.g., `KB-017 — Exceptions & edge cases`).
