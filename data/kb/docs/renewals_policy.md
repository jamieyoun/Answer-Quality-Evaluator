---
  doc_id: KB-008
  title: Renewals, Uplifts, and Renewal Exception Handling
  owner_team: CS Ops
...
# Renewals, Uplifts, and Renewal Exception Handling
...
Enablement guidance for **Renewals, Uplifts, and Renewal Exception Handling** at Northstar AI. This doc is intended to be used with related policies listed below; when policies conflict, follow the most recent **last_updated** date and escalate to the owner team.
...
- **legacy_customer_exceptions.md** (KB-021)
...
- **Where do I record an exception?**  
  Record exceptions in CRM under the account and attach the approval. Include doc IDs (e.g., KB-008) and an expiry date.
...
- 2026-03-01: Content refresh, additional examples, clearer exception language.
...
- **Citation guidance:** Cite **doc_id** + section header (e.g., `KB-008 — Exceptions & edge cases`).
