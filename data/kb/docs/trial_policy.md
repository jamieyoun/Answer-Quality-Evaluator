---
  doc_id: KB-007
  title: Trials, Pilots, and Proof-of-Value (PoV) Policy
...
# Trials, Pilots, and Proof-of-Value (PoV) Policy
...
Enablement guidance for **Trials, Pilots, and Proof-of-Value (PoV) Policy** at Northstar AI. This doc is intended to be used with related policies listed below; when policies conflict, follow the most recent **last_updated** date and escalate to the owner team.
...
- **professional_services.md** (KB-018)
...
- **Where do I record an exception?**  
  Record exceptions in CRM under the account and attach the approval. Include doc IDs (e.g., KB-007) and an expiry date.
...
- 2026-03-02: Content refresh, additional examples, clearer exception language.
- 2026-03-05: Effective date for the current version.

## Key fields

- **Region applicability:** US, EMEA, APAC
- **Escalation:** Sales Enablement → RevOps/Legal/Security as needed
- **Citation guidance:** Cite **doc_id** + section header (e.g., `KB-007 — Exceptions & edge cases`).
