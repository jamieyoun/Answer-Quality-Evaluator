---
  doc_id: KB-018
  title: Professional Services, SOWs, and Custom Work
  owner_team: Services
...
# Professional Services, SOWs, and Custom Work
...
Enablement guidance for **Professional Services, SOWs, and Custom Work** at Northstar AI. This doc is intended to be used with related policies listed below; when policies conflict, follow the most recent **last_updated** date and escalate to the owner team.
...
- **Where do I record an exception?**  
  Record exceptions in CRM under the account and attach the approval. Include doc IDs (e.g., KB-018) and an expiry date.
...
- 2026-02-26: Content refresh, additional examples, clearer exception language.
- 2026-03-01: Effective date for the current version.

## Key fields

- **Region applicability:** US, EMEA, APAC
- **Escalation:** Services → RevOps/Legal/Security as needed
- **Citation guidance:** Cite **doc_id** + section header (e.g., `KB-018 — Exceptions & edge cases`).
