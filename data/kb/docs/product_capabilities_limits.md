---
  doc_id: KB-023
  title: Product Capabilities, Limits & Known Constraints
  owner_team: Product
...
# Product Capabilities, Limits & Known Constraints
...
Enablement guidance for **Product Capabilities, Limits & Known Constraints** at Northstar AI. This doc is intended to be used with related policies listed below; when policies conflict, follow the most recent **last_updated** date and escalate to the owner team.
...
- **api_rate_limits.md** (KB-015)
- **supported_integrations.md** (KB-016)
- **release_notes_policy.md** (KB-024)
...
- **Where do I record an exception?**  
  Record exceptions in CRM under the account and attach the approval. Include doc IDs (e.g., KB-023) and an expiry date.
...
- 2026-03-07: Content refresh, additional examples, clearer exception language.
- 2026-03-12: Effective date for the current version.

## Key fields

- **Region applicability:** US, EMEA, APAC
- **Escalation:** Product → RevOps/Legal/Security as needed
- **Citation guidance:** Cite **doc_id** + section header (e.g., `KB-023 — Exceptions & edge cases`).
