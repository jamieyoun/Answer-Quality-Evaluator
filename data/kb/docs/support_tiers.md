---
doc_id: KB-009
title: "Support Tiers, Response Times, and Escalation Paths"
...
# Support Tiers, Response Times, and Escalation Paths
...
Enablement guidance for **Support Tiers, Response Times, and Escalation Paths** at Northstar AI. This doc is intended to be used with related policies listed below; when policies conflict, follow the most recent **last_updated** date and escalate to the owner team.
...
- **sla_and_uptime.md** (KB-010)
- **custom_slas.md** (KB-020)
- **security_and_compliance.md** (KB-011)
...
- **Where do I record an exception?**  
  Record exceptions in CRM under the account and attach the approval. Include doc IDs (e.g., KB-009) and an expiry date.
...
- 2026-03-04: Content refresh, additional examples, clearer exception language.
- 2026-03-04: Effective date for the current version.

## Key fields

- **Region applicability:** US, EMEA, APAC
- **Escalation:** Customer Support → RevOps/Legal/Security as needed
- **Citation guidance:** Cite **doc_id** + section header (e.g., `KB-009 — Exceptions & edge cases`).
