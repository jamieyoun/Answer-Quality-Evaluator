---
  doc_id: KB-005
  title: Usage Overage Fees & Fair Use
  owner_team: Finance
...
Enablement guidance for **Usage Overage Fees & Fair Use** at Northstar AI. This doc is intended to be used with related policies listed below; when policies conflict, follow the most recent **last_updated** date and escalate to the owner team.
...
- **Where do I record an exception?**  
  Record exceptions in CRM under the account and attach the approval. Include doc IDs (e.g., KB-005) and an expiry date.
...
- 2026-02-20: Content refresh, additional examples, clearer exception language.
...
- **Citation guidance:** Cite **doc_id** + section header (e.g., `KB-005 — Exceptions & edge cases`).
